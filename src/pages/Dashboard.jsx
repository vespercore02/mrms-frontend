  ...
  return (
    <div>
      ...
      <div style={styles.grid}>
        ...
        <Card title="Available Bays" value={summary?.storage?.availableBays} />
        <Card title="Near Full Bays" value={summary?.storage?.nearFullBays} />
        ...
        />
        <Card title="Storage Boxes" value={summary?.storage?.storageBoxes} />
        <Card title="Stored Records" value={summary?.storage?.storedRecords} />
